...
BLOCK_DEFAULTS = {
    ...
    ('contacts', 'label_address'): 'Адреса',
    ('contacts', 'label_phone'): 'Телефон',
    ('contacts', 'label_phone_secondary'): 'Додатковий телефон',
    ...
    ('booking', 'label_service'): 'Послуга',
    ('booking', 'label_doctor'): 'Лікар',
    ('booking', 'label_date'): 'Бажана дата',
    ('booking', 'label_time'): 'Бажаний час',
...
BLOCK_FIELD_LABELS = {
    ...
    'label_address': 'Підпис поля «Адреса»',
    'label_phone': 'Підпис поля «Телефон»',
    'label_phone_secondary': 'Підпис «Додатковий телефон»',
    ...
    'label_service': 'Підпис «Послуга»',
    'label_doctor': 'Підпис «Лікар»',
    'label_date': 'Підпис «Дата»',
    'label_time': 'Підпис «Час»',
...
INLINE_KEYS = frozenset({
    ...
    'label_address', 'label_phone', 'label_phone_secondary', 'label_email',
