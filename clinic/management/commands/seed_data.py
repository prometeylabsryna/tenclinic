...
class Command(BaseCommand):
    ...
    def _seed_directions(self, *, force=False):
        ...
        lor_data = [
            ...
            {
                'slug': 'shchelepno-lytseva-hirurgiya',
                'name': 'Щелепно-лицева хірургія',
                'short_description': (
                    'Лікування злоякісних та доброякісних пухлин, травм, вроджених вад і '
                    'захворювань обличчя, щелеп та шиї. Ми відновлюємо функцію й естетику, '
                    'використовуючи сучасні хірургічні методики.'
                ),
                'description': (
                    'Лікування злоякісних та доброякісних пухлин, травм, вроджених вад і '
                    'захворювань обличчя, щелеп та шиї. Ми відновлюємо функцію й естетику, '
            ...
            },
            {
                ...
                'name': 'Анестезіологія',
                'short_description': (
                    'Безпека пацієнта є нашим головним пріоритетом. Індивідуальний підбір '
                    'анестезії, моніторинг життєво важливих показників і сучасні підходи для '
                    'комфорту та безпеки на всіх етапах оперативного лікування.'
                ),
                'description': (
                    'Безпека пацієнта є нашим головним пріоритетом. Анестезіологічний '
                    'супровід у TEN clinic — це індивідуальний підбір анестезії, '
                    'безперервний моніторинг життєво важливих показників і сучасні підходи, '
                    'що забезпечують максимальний комфорт та безпеку на всіх етапах '
    ...
    def _seed_doctors(self, directions, *, force=False):
        ...
        by_slug = {d.slug: d for d in Direction.objects.all()}
        doctors_data = [
            {
                'slug': 'nekrasova-yana',
                'full_name': 'Некрасова Яна Петрівна',
                'specialization': 'Отоларинголог, отоларинголог дитячий, сурдолог',
                'direction_slugs': [
                    'otolaryngologiya',
                    'dytacha-otolaryngologiya',
                    'surdologiya',
                ],
                'education': '\n'.join([
                    'Закінчила Дніпропетровську державну медичну академію у 2010 році.',
                    'Інтернатура по дитячій отоларингології — 2011–2012 роки.',
                    'Спеціалізація: сурдологія.',
                    'Спеціалізація: отоларингологія.',
                ]),
                'bio': '\n'.join([
                    'Працювала у Міській клінічній лікарні № 8 — 2013–2019 рр.',
                    'Міська багатопрофільна клінічна лікарня матері та дитини '
                    'ім. проф. Руднєва — з 2019 року по теперішній час.',
                ]),
                'experience_years': 16,
                'order': 0,
            },
            {
                'slug': 'tereshkov-denys',
                'full_name': 'Терешков Денис Юрійович',
                'specialization': 'Щелепно-лицьовий хірург',
                'direction_slugs': ['shchelepno-lytseva-hirurgiya'],
                'education': '\n'.join([
                    'У 2010 році закінчив Дніпропетровську державну медичну академію, '
                    'після чого пройшов інтернатуру за спеціальністю «Стоматологія» '
                    '(2010–2012) та магістратуру на базі Обласної лікарні імені '
                    'І. І. Мечникова.',
                    'Спеціалізацію з хірургічної стоматології здобув у Запорізькій '
                    'медичній академії післядипломної освіти.',
                    'Спеціалізацію зі щелепно-лицевої хірургії — у Харківському '
                    'національному університеті імені В. Н. Каразіна.',
                ]),
                'bio': '\n'.join([
                    'Професійну діяльність розпочав у 2012 році.',
                    'Лікар щелепно-лицевий хірург у Дніпропетровській обласній '
                    'клінічній лікарні імені І. І. Мечникова — 2012–2020 роки; '
                    'одночасно — у відділенні дитячої щелепно-лицевої хірургії '
                    'Міської клінічної лікарні № 8 — 2012–2019 роки.',
                    'Відділення щелепно-лицевої хірургії для дорослих і дітей '
                    'у Міській багатопрофільній лікарні матері та дитини '
                    'ім. Руднєва — 2019–2024 роки.',
                    'З 2024 року очолює відділення щелепно-лицевої хірургії '
                    'для дорослих і дітей Регіонального медичного центру '
                    'родинного здоровʼя.',
                    'Спеціалізується на реконструктивній, онкологічній та дитячій '
                    'щелепно-лицевій хірургії, впроваджуючи сучасні методики '
            ...
            {
                'slug': 'novikov-yaroslav',
                'full_name': 'Новіков Ярослав Костянтинович',
                'specialization': 'Отоларинголог, отоларинголог дитячий',
                'direction_slugs': ['otolaryngologiya', 'dytacha-otolaryngologiya'],
                'education': '',
                'bio': 'Текст буде додано.',
                'experience_years': 0,
                'order': 2,
            },
            {
                'slug': 'yehorov-sergij',
                'full_name': 'Єгоров Сергій Валерійович',
                'specialization': (
                    'Лікар-анестезіолог, лікар-анестезіолог дитячий вищої категорії, '
                    'заслужений лікар України, завідувач відділенням реанімації'
                ),
                'direction_slugs': ['anesteziologiya'],
                'education': '',
                'bio': '\n'.join([
                    'Забезпечує кваліфіковане проведення анестезіологічного '
                    'забезпечення та інтенсивної терапії при різних патологічних '
                    'процесах.',
                    'Приймає активну участь у поширенні медичних знань про '
            ...
            {
                'slug': 'yehorova-olha',
                'full_name': 'Єгорова Ольга Олександрівна',
                'specialization': 'Лікар-анестезіолог, лікар-анестезіолог дитячий',
                'direction_slugs': ['anesteziologiya'],
                'education': '',
                'bio': '\n'.join([
                    'Багаторічний досвід роботи у дитячій та дорослій реанімації; '
                    'транспортування пацієнтів у критичному стані; проведення '
                    'різних видів анестезії у пацієнтів офтальмологічного, '
                    'щелепно-лицевого, стоматологічного, ЛОР та інших профілів.',
                ]),
                'experience_years': 17,
                'order': 4,
            },
        ...
        for item in doctors_data:
            direction_slugs = item.pop('direction_slugs')
            ...
            doctor.directions.set([by_slug[slug] for slug in direction_slugs])
